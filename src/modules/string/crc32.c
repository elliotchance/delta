 ...
 *
 * Generates the cyclic redundancy checksum polynomial of 32-bit lengths of the str. This is usually
 * used to validate the integrity of data being transmitted.
 *
 * @param str The data.
 * @return Returns the crc32 checksum of str as an integer.
 */
DELTA_FUNCTION(crc32)
{
	int release;
